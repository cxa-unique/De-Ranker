...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, return_pooled_cls=False, return_hidden_states=False):
        ...
        if return_pooled_cls and return_hidden_states:
            return logits, pooled_output, sequence_output
        elif return_pooled_cls:
